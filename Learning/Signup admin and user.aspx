<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup admin and user.aspx.cs" Inherits="Learning.Signup_admin_and_user" %>
...
<body>
    ...
    <form id="form1" runat="server">
         <div class="auto-style16">
            <h2 style="text-align:center;color:#3c00a0;Font-Bold:True; font-weight: bold;" >SIGNUP HERE ....</h2>
             <br />
            ...
            <table class="auto-style6">
                ...
                <tr>
                    ...
                    <td class="auto-style15">
                        <asp:LinkButton ID="lb2" runat="server" BackColor="#3c00a0" BorderColor="Blue" Font-Size="30px" ForeColor="White" Height="62px" PostBackUrl="~/Registration.aspx" Width="330px" BorderStyle="Solid"  CssClass="auto-style17" style="text-align:center;" >SIGNUP AS ADMIN</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style11" >&nbsp;</td>
               ...
               <tr>
                    ...
                    <td class="auto-style10" style="font-size:20px"> 
                        <asp:LinkButton ID="lb1" runat="server" BackColor="#3c00a0" BorderColor="Blue" Font-Size="30px" ForeColor="White" Height="62px" PostBackUrl="~/Registration.aspx" Width="330px" BorderStyle="Solid" style="text-align:center" >SIGNUP AS LEARNER</asp:LinkButton>
                     </td>
                </tr>
         <tr>
                    <td class="auto-style11" >&nbsp;</td>
