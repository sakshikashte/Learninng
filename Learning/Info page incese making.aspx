<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Info page incese making.aspx.cs" Inherits="Learning.Info_page_incese_making" %>
...
<body>
    ...
    <div class="section" style="width: 1500px; height: 310px;">
        <div class="text">
            <br />
            <br />
           <h1 style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Incense Stick Making Course - for <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to Build a Business</h1>
            <br />
            <p style="font-size: 20px;font-weight:bold;text-align:left"  >
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Learn the Ancient Art of Incense Making. Simply the best way to fill your home with <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; wonderful and fragrant scent. <br />
                </div>

                    <br />
&nbsp;<img src="img/agarbatti3.jpg"  alt="" class="auto-style3" style="text-align: center;margin-top:30px;margin-left:80px"/>
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Understanding the process of incense making.</p>
      

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Make different types of combustible and non-combustible.</p>
        

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Understanding incense materials and their role in the incense system so you can adapt and test.</p>
         

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Be able to practice and create your own incense sticks.</p>
            <br />
    ...
    <ul style="list-style-type:square; font-size:20px;color:black">
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>&nbsp; Aromatic Ingredients.</li>
      
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Natural Aromatic Oil</li>
    
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Packing Materials: The packing material used must be airtight that locks the fragrance of the agarbatti.</li>
        
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Raw Bamboo Sticks.</li>
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Different Color Powder: One can add different color powders to make agarbattis look attractive.
</li>
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> The powders are:-
...
Sawdust
        ...
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Addition of Fragrance</li>
   ...
   <br />
    ...
    <br />
        ...
        <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Welcome to this fantastic course,you will learn how to make your won incense using 100% natural materials in practical ,easy,and affordable way. At the end of the course you will able to make different types of incense for your house,business,worship,medition or aromatherapy. No synthetics chemicals are allowed.</p>
            <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This will help you to understand all apspects of incense stick making and will allow you to explore and create your own incense sticks according to your needs. </p>
        
        </div>
    <br />
    <br />
    
    <div style="border-style: groove; background-color:wheat; margin-left:43px;" class="auto-style11">
        <br />
   ...
   <div class="videos">
       <iframe width="560" height="315" src="https://www.youtube.com/embed/KueHSh-yVVM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
    <div class="videos">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/JqXeNNbhwVA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
   </div>
    ...
    <div class="auto-style10">
        <div class="videos">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/XULY8EBuOus" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>   </div>
        </div>
    <br />
    ...
    <br />
     <div style="border-style: groove; background-color:wheat;" class="auto-style8">
        ...
        <br />
         ...
         <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If You Want to Get Procedure<a href="Course%20Details/Incese%20stick%20making%20procedure.pdf" style="color:darkblue">Click Here</a></h4>
