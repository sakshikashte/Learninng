<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin panel.aspx.cs" Inherits="Learning.ADMIN_PANEL1.Admin_panel" %>
...
<!--geo chart-->
    ...
    <link href="css3/demo-page.css" rel="stylesheet" />
    <link href="css3/examples.css" rel="stylesheet" />
    <link href="css3/font-awesome.css" rel="stylesheet" />
    <link href="css3/geochart.css" rel="stylesheet" />
    <link href="css3/hover.css" rel="stylesheet" />
    <link href="css3/magnific-popup.css" rel="stylesheet" />
    <link href="css3/style.css" rel="stylesheet" />

    <a href="fonts3/fontawesome-webfont.eot"></a>
    <a href="fonts3/fontawesome-webfont.svg"></a>
    <a href="fonts3/fontawesome-webfont.ttf"></a>
    <a href="fonts3/fontawesome-webfont.woff"></a>
    <a href="fonts3/fontawesome-webfont.woff2"></a>
    <a href="fonts3/FontAwesome.otf">fonts3/FontAwesome.otf</a>
    <a href="fonts3/glyphicons-halflings-regular.eot"></a>
    <a href="fonts3/glyphicons-halflings-regular.svg"></a>
    <a href="fonts3/glyphicons-halflings-regular.ttf"></a>
    <a href="fonts3/glyphicons-halflings-regular.woff"></a>
    <a href="fonts3/glyphicons-halflings-regular.woff2"></a>

    <script src="js3/bars.js"></script>
    ...
    <script src="js3/jquery.magnific-popup.js"></script>
    <script src="js3/jquery.nicescroll.js"></script>
    <script src="js3/modernizr.min.js"></script>
    <script src="js3/nivo-lightbox.min.js"></script>
...
<div class="page-container">	
   <div class="left-content">
       <a href="Site1.Master"></a>
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="index.html"> <h3 style="color:orangered">Admin Panel</h3> 
...
<div class="copyrights">
	 <p>© 2023 SKILLHUB. All Rights Reserved | Design by  <a href="" target="_blank">Sakshi Kashte</a> </p>
</div>	
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="Admin panel.aspx"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
		        <li><a href="../Add%20Courses%20to%20DB.aspx"><i class="fa fa-book nav_icon"></i><span>Add Course</span><span  style="float: right"></span></a>
		          </li>
				  
		        <li id="menu-comunicacao" ><a href="admin Courses Details.aspx"><i class="fa fa-book nav_icon"></i><span>Course Details</span><span  style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		             </ul>
		        </li>
		          <li><a href="maps.html"><a href="admin order.aspx"><i class="fa fa-book nav_icon"></i><span>Order Details</span></a></li>
		       
		        
		        <li><a href="charts.html"><a href="Admin CustomerFeedback.aspx"><i class="fa fa-book nav_icon"></i><span>Customer Feedback Details</span></a></li>
		        <li><a href="admin contact details.aspx"><i class="fa fa-envelope"></i><span>Contact Details</span><span  style="float: right"></span></a>
		        	
		        </li>
				  <li><a href="Learner details.aspx"><i class="fa fa-book nav_icon"></i><span>Learner Details</span></a></li>
