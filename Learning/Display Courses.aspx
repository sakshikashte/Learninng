<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Display Courses.aspx.cs" Inherits="Learning.Display_Courses" %>
...
<table>
	<tr>
		...
		<asp:DataList ID="DataList1" runat="server" DataKeyField="CourseName" DataSourceID="SqlDataSource1" Height="160px" Width="1322px" RepeatColumns="3" RepeatDirection="Horizontal" HorizontalAlign="Center" >
			<ItemTemplate>
				<table>
					<tr>
						<td style="text-align:center;border:groove;border-color:black"auto-style3">
							<asp:Image ID="Image1" runat="server" BorderColor="Black" BorderWidth="1px" Height="300px" Width="339px" 
								ImageUrl='<%# Eval("CourseImage") %>' BorderStyle="Solid"/>
						</td>
					</tr>
					<!--<tr>
						<td class="auto-style3" style="text-align:center; background-color:#F2184F">
							...
							<asp:Label ID="Label1" runat="server" Text='<%# Eval("CourseId") %>'  ForeColor="black"></asp:Label>
						</td>
					</tr>-->
					<tr>
						<td style="text-align:center; background-color:white;border-left-style: groove;border-right-style: groove;border-top-style:groove;border-color:black" class="auto-style3">
							<asp:Label ID="Label11" runat="server" Font-Bold="true" Font-Names="arial" ForeColor="black" style="text-align:center;font-weight:bold" ></asp:Label>
                            <asp:Label ID="Label12" runat="server" ForeColor="#0033CC" Text='<%# Eval("CourseName") %>' Font-Bold="True" Font-Size="X-Large"></asp:Label>
						</td>
					</tr>
					<tr>
						<td style="text-align:center; background-color:white;border-right-style:groove;border-left-style: groove;border-color:black" class="auto-style4">
							<asp:Label ID="Label9" runat="server" Font-Bold="true" Font-Names="arial" ForeColor="black" style="text-align:center"></asp:Label>
							<asp:Label ID="Label10" runat="server" ForeColor="black" Text='<%#Eval("CourseDescription") %>'></asp:Label>
					...
					<tr>
						<td align="center" style="background-color: white; color: #000000; font-weight: bold; border-bottom:groove; border-right-style: groove; border-bottom-style:groove; border-left-style: groove;border-color:black" class="auto-style3">&nbsp;</td>
					</tr>
					<tr>
						<td style="text-align:center" class="auto-style3">
                            
							<asp:ImageButton ID="ImageButton1" runat="server" Height="84px" ImageUrl="img/button2.jpg" Width="202px"
								CommandArgument='<%#Eval("CourseName")%>' CommandName="AddToCart" PostBackUrl="~/Login form.aspx"  />
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [DisplayCourses]"></asp:SqlDataSource>
