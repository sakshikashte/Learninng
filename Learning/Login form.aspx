<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login form.aspx.cs" Inherits="Learning.Login_form" %>
     ...
     <form id="form1" runat="server">
        ...
        <br />
            <div class="btn-field">
                ...
                <asp:Button ID="btn2" runat="server" Height="51px" Text="Login" Width="135px" BackColor="#3c00a0" Font-Size="25px" BorderColor="Blue" BorderWidth="2px" Font-Bold="True" ForeColor="white" OnClick="btn2_Click"  />
