...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info page candle.aspx.cs" Inherits="Learning.Info_page_candle" %>
...
<body>
    ...
    <div class="section" style="width: 1500px; height: 310px;">
        <div class="text">
            <br />
            <br />
           <h1 style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Candle Making for Beginners - for Fun or <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to Build a Business</h1>
            <br />
            <p style="font-size: 20px;font-weight:bold;text-align:left"  >
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Learn how to easily make gorgeous candles to use yourself, give to other or to start <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; your own craft business. Here chance to learn the Candle Making. Learn what it takes to make <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; a candle and leave it with a masterpiece.&nbsp;&nbsp;&nbsp;&nbsp;
                </div>

                    <br />
&nbsp;<img src="img/candle.jpg"  alt="" class="auto-style3" style="text-align: center;"/>
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Introduction on Handmade Wax.</p>
      

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Learn about different types of candle shades and perfumes.</p>
        

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Right Temperature and pouring techniques.</p>
         

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Knowledge about different types of candle making equipment.</p>
            <br />
    ...
    <ul style="list-style-type:square; font-size:20px;color:black">
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Different types of wax such as Paraffin Wax,Soy Wax,Gel Wax.</li>
      
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Different type of moulds such as Metal Mould,Silicon Mould.</li>
    
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Different type of decorative gels of candles.</li>
        
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Container,Candle Colours,Metal Tray, Wax Paper.</li>
   ...
   <br />
    ...
    <br />
        ...
        <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; You will learn how to work with different candle waxes, wicks, containers, fragrances, colours.You will learn how to make scented and coloured soy wax candles.You will learn how to make new candles from old.</p>
   ...
   <div class="videos">
    ...
    <div class="videos">
            <iframe height="315" src="https://www.youtube.com/embed/Xdb1a3kweMg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen class="auto-style10"></iframe>
   </div>
    ...
    <div style="border-style: groove; background-color:wheat;margin-left:43px" class="auto-style8">
        ...
        <br />
         ...
         <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If You Want to Get Procedure<a href="Course%20Details/Candle%20making%20procedure.pdf" style="color:darkblue">Click Here</a></h4>
        </div>
