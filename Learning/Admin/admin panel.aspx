<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin panel.aspx.cs" Inherits="Learning.Admin.admin_panel" %>
        ...
        <div class="box" >
          <div class="right-side">
            <div class="box-topic">Registered Learners</div>
              <br />
            <div class="number" style="text-align:center;font-size:xx-large">20</div>
              </div>
        </div>
        <div class="box">
          <div class="right-side">
...
<li>
        ...
        <div class="sales-boxes">
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="Email" DataSourceID="SqlDataSource1">
             <Columns>
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" DataField="Id" HeaderText="Id" InsertVisible="False" ReadOnly="True" SortExpression="Id" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" DataField="Name" HeaderText="Name" SortExpression="Name" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" DataField="Email" HeaderText="Email" ReadOnly="True" SortExpression="Email" />
                    ...
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px" DataField="Message" HeaderText="Message" SortExpression="Message" />
                </Columns>
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [Contact]"></asp:SqlDataSource>
          </div>
        </div>
        </div>-->
  </section>
