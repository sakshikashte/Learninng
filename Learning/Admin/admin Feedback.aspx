<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin Feedback.aspx.cs" Inherits="Learning.Admin.admin_Feedback" %>
...
<li>
        ...
        <div class="sales-boxes">
         <div class="recent-sales box">
          <div class="title">Learner Feedback Details</div>
             <br />
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="Email" DataSourceID="SqlDataSource1" Height="234px" Width="527px">
             <Columns>
                  ...
                  <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" DataField="Feedback" HeaderText="Feedback" SortExpression="Feedback" />
             ...
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [Feedback]"></asp:SqlDataSource>
          </div>
        </div>
        </div>
       <br />
