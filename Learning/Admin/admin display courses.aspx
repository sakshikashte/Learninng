<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin display courses.aspx.cs" Inherits="Learning.Admin.admin_display_courses" %>
        ...
        <div class="sales-boxes">
         <div class="recent-sales box">
          <div class="title">Course Details</div>
             <br />
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="CourseName" DataSourceID="SqlDataSource1" Height="237px" Width="567px">
             <Columns>
                    
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" DataField="CourseName" HeaderText="Course Name" SortExpression="CourseName" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" DataField="CourseDescription" HeaderText="Course Description" ReadOnly="True" SortExpression="CourseDescription" />
                    <asp:BoundField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100px" DataField="CourseImage" HeaderText="Course Image" SortExpression="CourseImage" />
