<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin contact detaisl.aspx.cs" Inherits="Learning.Admin.admin_contact_detaisl" %>
        ...
        <div class="sales-boxes">
         <div class="recent-sales box">
          <div class="title">Contact Details</div>
             <br />
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="Email" DataSourceID="SqlDataSource1" Height="184px">
             <Columns>
