<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info page phenyle.aspx.cs" Inherits="Learning.Info_page_phenyle" %>
...
<body>
    ...
    <div class="section" style="width: 1500px; height: 310px;">
        <div class="text">
            <br />
            <br />
           <h1 style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Phenyle Making  - Home Care Package <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h1>
            
            <p style="font-size: 20px;font-weight:bold;text-align:left"  >
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               In this course you will explore the formulation of phenyle making , variants of <br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; phenyl making the floor cleaner for multipurpose and to remove stubborn dirt the floor,<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; fabricating your own liquid dishwash to have degreasing utensils.<br />
                </p>
                </div>

                    <br />
&nbsp;<img src="img/phenyle.jpg"  alt="" class="auto-style3" style="text-align: center;margin-top:30px;margin-left:80px"/>
...
>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>You making products which clean the surroundings and areas around.Also the utensils in which we eat need to be clean with the right kind of dishwash.
                    </p>
      

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>It give you the thorough understanding on making variant toilet cleaners to remove the biological debris from the toilet.</p>
        

             <p style="font-size:20px;color:black">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i>Making of various types of phenyl emulsifier.</p>
    ...
    <ul style="list-style-type:square; font-size:20px;color:black">
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Pine Oil Concentrate between 22%-26%.</li>
      
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Emulsifier.</li>
    
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Graduated cylinder or Measuring Cup.</li>
        
        <li class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Water,Plastic Bottle,Spoon.</li>
   ...
   <div class="videos">
       <iframe width="560" height="315" src="https://www.youtube.com/embed/HdONttsGHAY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
   </div>
    <div class="videos">
           <iframe width="560" height="315" src="https://www.youtube.com/embed/6n9a_MSFyfY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
   </div>
    ...
    <div class="video-section">
        <div class="videos">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/332pWwO_L0A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
...
<br />
  ...
  <div style="border-style: groove; background-color:wheat;margin-left:43px" class="auto-style8">
        ...
        <br />
         ...
         <h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If You Want to Get Procedure<a href="Course%20Details/Phenyle%20making%20procedure.pdf" style="color:darkblue">Click Here</a></h4>
        </div>
